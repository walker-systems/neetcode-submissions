...
public class Solution {
    ...
    // Implementing Comparable allows the PriorityQueue to sort automatically.
    ...
    public Map<Integer, Integer> shortestPath(int n, List<List<Integer>> edges, int src) {
        ...
        // Updated to unpack elements using .get() from the List API
        ...
        while (!pq.isEmpty()) {
            ...
            // This implicitly handles "stale" elements in the queue without needing an update operation.
